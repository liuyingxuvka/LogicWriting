...
This checklist describes the `4.0.4` corrective release. Checkboxes are coordination aids,
...
- [ ] Freeze `VERSION`, `pyproject.toml`, both README source badges, changelog,
  ...
  SkillGuard consumer-distribution identity on the same `4.0.4` source tree.
...
- [ ] Push the default branch, create signed/annotated `v4.0.4` as configured,
