...
This checklist describes the `3.0.0` cutover. Checkboxes are coordination aids,
...
- [ ] Freeze `VERSION`, `pyproject.toml`, both README source badges, changelog,
  ...
  SkillGuard consumer-distribution identity on the same `3.0.0` source tree.
...
- [ ] Push the default branch, create signed/annotated `v3.0.0` as configured,
