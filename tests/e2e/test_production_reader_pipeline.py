...
def scenario(tmp_path, monkeypatch):
    def make(owner="investigation", native_status="research_handoff_ready", mutation=None):
        ...
        monkeypatch.setattr(pipeline.InstalledResearchGuardProvider, "_console", lambda self: ("synthetic-console", {"provider_id": "researchguard", "version": "0.5.2", "test_mode": "protocol_only"}))
