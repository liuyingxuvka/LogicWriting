...
BINDINGS = (
    ...
    BindingSpec(
        ...
        "predecessors become private only after recovery gates and in Travel-then-Storyline order, followed by a user deletion handoff",
        "development_process",
    ...
    BindingSpec(
        "obligation:fiction-route",
        "fiction preserves route-native story, continuity, Guard, semantic-review, and actual-manuscript binding evidence",
        "agent_operation",
        "intent:produce-fiction-artifact",
        "C12:produce-fiction-artifact",
        "logic_writing.fiction",
        "contract:fiction-native-regression",
        "scripts/run_fiction_regression.py",
        "main",
        "test:fiction-route",
        "test_named_binding_failure_family_is_preserved",
        "tests/unit/test_fiction.py",
        ("happy_path", "negative_path"),
    ),
    BindingSpec(
        "obligation:travel-route",
        "travel preserves current evidence, feasibility, fit, reachable fallback, and actual-guide closure evidence",
        "agent_operation",
        "intent:produce-travel-guide",
        "C13:produce-travel-guide",
        "logic_writing.travel",
        "contract:travel-native-regression",
        "scripts/run_travel_regression.py",
        "main",
        "test:travel-route",
        "test_travel_case_families_remain_complete",
        "tests/unit/test_travel.py",
        ("happy_path", "negative_path"),
    ),
    BindingSpec(
        "obligation:shared-model-artifact-binding",
        "shared writing binds reader-state contributions and current model rows to exact artifact spans without sibling ownership",
        "agent_operation",
        "intent:bind-model-to-reader-artifact",
        "C14:bind-model-to-reader-artifact",
        "logic_writing.reader.binding",
        "contract:shared-writing",
        "skills/logic-writing/scripts/validate_shared_writing.py",
        "validate_shared_writing",
        "test:shared-writing",
        "test_generic_handoff_and_unbound_prose_fail",
