...
Managed skills:
- `skills/logic-writing` — native owner=`logic-writing`, route evidence=`skills/logic-writing/SKILL.md`; the target skill keeps domain-route, judgment, action, and native-check authority.
