...
The repository SHALL have one current author contract and MUST NOT retain the retired SkillGuard author identity as a compatibility or fallback authority. Source version `4.0.2`, installed projection, package metadata where applicable, Git commit, version tag, and GitHub Release SHALL be independently verified before release closure. This maintenance requirement does not create an automatic updater for other computers.
