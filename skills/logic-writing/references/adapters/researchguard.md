...
Logic Writing uses the released ResearchGuard `0.5.2` provider and three
...
output, and supported version must all be `0.5.2`. They do not prove that
...
for Logic Writing `4.0.1`; they execute no provider command.
